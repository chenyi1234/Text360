...
//                                1.0, 1.0);
#warning 改变里面的x，y 坐标 可是改变水平滑动 垂直滑动与否 目前别的功能还没摸索出来
  
  GLKVector4  screen = GLKVector4Make(1.5*(point.x/self.frame.size.width-0.5),
                            0*(0.5-point.y/self.frame.size.height),
                            0,1);
